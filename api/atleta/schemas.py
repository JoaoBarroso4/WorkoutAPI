...
class AtletaSchema(BaseSchema):
    ...
    data_nascimento: Annotated[
        date, Field(description="Data de nascimento do atleta", example="2000-01-01", format="date")]
...
class AtletaUpdateSchema(AtletaSchema):
    ...
    cpf: Annotated[Optional[str], Field(description="CPF do atleta", example="123.456.789-00", max_length=14)]
    data_nascimento: Annotated[
        Optional[date], Field(description="Data de nascimento do atleta", example="2000-01-01", format="date")]
    peso: Annotated[Optional[PositiveFloat], Field(description="Peso do atleta", example=70.5)]
    altura: Annotated[Optional[PositiveFloat], Field(description="Altura do atleta", example=1.75)]
    sexo: Annotated[Optional[str], Field(description="Sexo do atleta", example="M", max_length=1)]
    categoria: Annotated[Optional[CategoriaInSchema], Field(description="Categoria do atleta")]
    centro_treinamento: Annotated[
        Optional[CentroTreinamentoInSchema], Field(description="Centro de treinamento do atleta")]
